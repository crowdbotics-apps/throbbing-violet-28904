...
## Project Structure
    ...
    ├── throbbing_violet_28904  # Django project configurations
...
1. Clone this repo and `cd throbbing_violet_28904`
...
2. Clone this repo and `cd throbbing_violet_28904`
